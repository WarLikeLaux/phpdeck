...
$p->price = 599.99;',
            ...
            [
                ...
                'answer' => '$this - это специальная псевдо-переменная, которая внутри метода ссылается на текущий объект (тот, на котором был вызван метод). Через $this можно обращаться к свойствам и методам этого же объекта. $this существует только внутри нестатических методов класса. В статическом методе объекта нет вообще - для обращения к статическим членам класса используют self:: / static:: / parent::.',
                'code_example' => '<?php
class User
{
    public string $name;
