...
**Чем отличается от VM:** не виртуализирует ОС — использует **ядро хоста** через `namespaces` and `cgroups`. Поэтому образ весит **мегабайты**, стартует **за секунду**.
...
- **Continuous Deployment** — деплоется **автоматически** после зелёного CI, без кнопок
...
server {
    ...
    client_max_body_size 20M;
            ...
            [
                'category' => 'DevOps',
                'question' => 'Что настраивают in php-fpm pool: pm static vs dynamic vs ondemand?',
