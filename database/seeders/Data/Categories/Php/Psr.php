    ...
    public static function all(): array
    {
        return [
            ...
            [
                ...
                'answer' => 'PSR-12 — расширенный стандарт стиля кодирования, заменивший устаревший PSR-2 и описывающий более полный набор правил: четырёхпробельные отступы без табуляций, мягкий лимит строки 80 символов и жёсткий 120, открывающая фигурная скобка классов и методов на новой строке, обязательное объявление видимости у всех свойств и методов, type hints там где возможно. Сегодня PSR-12 формально заменён «живым» документом PER Coding Style, который продолжает его развитие.',
                'difficulty' => 2,
                'topic' => 'php.psr',
            ],
            [
