...
STRIPE_SECRET=",
            ...
            [
                ...
                'answer' => 'Случайный 32-байтовый ключ в .env (генерируется через php artisan key:generate). Laravel использует его для: шифрования куки и сессии, encrypt() / Crypt-фасада, подписи signed URLs. Если ключ утёк — атакующий может расшифровать куки и подделать сессии. Если ключ потеряли — все зашифрованные данные станут нечитаемыми. На каждом окружении должен быть свой ключ, никогда не одинаковый dev/prod.',
                'difficulty' => 2,
                'topic' => 'security.secrets',
            ],
            [
