...
[![Cards](https://img.shields.io/badge/cards-1799-9553E9)](#)
...
В колоде **1799 вопросов** по 154 топикам — от junior-базы до middle/senior собеседований. Прогресс свой — много пользователей не мешают друг другу.
...
1799 карточек по 154 топикам, из них ~500 на уровне «base» (difficulty 1-2) — ровная подготовка от junior-фундамента до middle/senior нюансов:
