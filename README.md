...
[![Cards](https://img.shields.io/badge/cards-1803-9553E9)](#)
...
В колоде **1803 вопроса** по 152 топикам — от junior-базы до middle/senior собеседований. Прогресс свой — много пользователей не мешают друг другу.
...
1803 карточки по 152 топикам, из них ~500 на уровне «base» (difficulty 1-2) — ровная подготовка от junior-фундамента до middle/senior нюансов:
